...
import 'package:mydatatools/modules/files/services/scanners/local_file_scanner.dart';
...
void main() {
  ...
  group('DatabaseRepository', () {
    late DatabaseManager databaseManager = DatabaseManager.instance;
    io.Directory? path;
    ...
    test('Scan project macos Dir', () async {
      ...
      Collection? c =
          await (db?.select(db.collections)
            ?..where((tbl) => tbl.name.equals("test")))?.getSingleOrNull();
      if (c == null) {
